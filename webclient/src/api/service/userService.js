...
export const createUser = async data => {
  const url = `${'http://ec2-107-20-127-176.compute-1.amazonaws.com:3000/routes/api/v1/user'}`;
...
export const updateUser = async (userId, data) => {
  const url = `${'http://ec2-107-20-127-176.compute-1.amazonaws.com:3000/routes/api/v1/user'}/${userId}`;
  const config = headers.content_type.application_json;
...
export const deleteUser = async id => {
  const url = `${'http://ec2-107-20-127-176.compute-1.amazonaws.com:3000/routes/api/v1/user'}/${id}`;
  const config = headers.content_type.application_json;
...
export const searchUserLogin = async email => {
  const url = 'http://ec2-107-20-127-176.compute-1.amazonaws.com:3000/routes/api/v1/user/login';
  const config = headers.content_type.application_json;
